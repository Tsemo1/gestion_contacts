...
( 1,5, 'Mémo n°1', 'Texte du mémo n°1', TRUE ,'F', 2, 1234.56, {d '2023-02-25' }, {t '18:30' }),
( 2,NULL,'Mémo n°2', 'Texte du mémo n°2', FALSE,'E', 4, 5000.00, {d '2023-05-18' }, {t '09:15' }),
( 3, 6,'Mémo n°3', NULL, TRUE,'A', NULL, NULL, NULL, NULL);
...
--service
INSERT INTO service (idservice,idpersonne, nom, anneecreation, flagsiege ) VALUES
( 1,5, 'wilma', 2000, TRUE ),
( 2,NULL,'leslie', 2001, FALSE ),
( 3, 6,'mamou', 2002, TRUE ),
( 4, 2,'bébéZek', 2003, FALSE );
